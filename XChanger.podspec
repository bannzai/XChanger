#
#  Be sure to run `pod spec lint XChanger.podspec' to ensure this is a
...
```
  ...
  spec.homepage     = "https://github.com/bannzai/XChanger"
  ...
  spec.source       = { :git => "https://github.com/bannzai/XChanger.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/XChanger/*.swift"
